...
This pulse train will be deformes by the channel and we receive $y[n]=h[n]*x[n]$.\\
...
\begin{figure}[H]
	\centering
    	...
    	\input{resources/labday2/autocorrelatie1.tikz}    	
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/autocorrelatie2.tikz}    	
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/autocorrelatie3_3.tikz}    	
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/autocorrelatie4_3.tikz}    	
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/svd1.tikz}    	
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/svd2.tikz}    	
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/svd3.tikz}    	
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/svd4.tikz}    	
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/error_0.01.tikz}    	
    	\caption{Singular values of \texttt{x3}}
    	\label{fig:error1}
\end{figure}
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/error_0.01_2.tikz}    	
    	\caption{Singular values of \texttt{x4}}
    	\label{fig:error2}
\end{figure}
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/crossx1.tikz}    	
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/crossx2.tikz}    	
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/crossx3.tikz}    	
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{6cm}
    	\setlength\figurewidth{10cm}
    	\input{resources/labday2/crossx4.tikz}    	

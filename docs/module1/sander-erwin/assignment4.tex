...
\begin{figure}[H]
	\centering
    	...
    	\input{resources/resistance-forces-reduced.tikz}
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{4cm}
    	\setlength\figurewidth{0.8\linewidth}
    	\input{resources/motor-torque-power-reduced.tikz}
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{4cm}
    	\setlength\figurewidth{0.8\linewidth}
    	\input{resources/wheel-torque-reduced.tikz}
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{4cm}
    	\setlength\figurewidth{0.8\linewidth}
    	\input{resources/battery-output-reduced.tikz}
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{4cm}
    	\setlength\figurewidth{0.8\linewidth}
    	\input{resources/power-req.tikz}
    	\label{fig:power-req}
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{4cm}
    	\setlength\figurewidth{0.8\linewidth}
    	\input{resources/resistance-forces-reduced-labcar.tikz}
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{4cm}
    	\setlength\figurewidth{0.8\linewidth}
    	\input{resources/motor-torque-power-reduced-labcar.tikz}
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{4cm}
    	\setlength\figurewidth{0.8\linewidth}
    	\input{resources/wheel-torque-reduced-labcar.tikz}
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{4cm}
    	\setlength\figurewidth{0.8\linewidth}
    	\input{resources/battery-output-reduced-labcar.tikz}
...
\begin{figure}[H]
	\centering
    	\setlength\figureheight{4cm}
    	\setlength\figurewidth{0.8\linewidth}
    	\input{resources/power-req-labcar.tikz}

...
Range = [2,2.5,3,3.5,4,4.5,5,5.5,6,6.5]; % put your set of ranges here
Power = [85.389, 84.080, 74.904, 59.965, 50.458, 42.414, 35.624, 30.191, 25.595, 21.312]  ;      % put your set of measured signal amplitudes
